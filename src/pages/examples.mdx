---
# This is the header. It is enclosed in --- 
# In the header, comments are prefixed with a hash (#).
# In the rest of a .mdx document, comments are wrapped up {/* like this */}
title: 'Markup examples'
layout: '~/layouts/MarkdownLayout.astro'
---
{/* The import commands below define which components may be used on this page.
*/}
...
{/* This is MarkDown text. It is normal text, with additional formatting characters that define show the text should be displayed
...
This is another paragraph of normal text.  [This is a link](../about/)

{/* These are examples of components.
  Components are enclosed in <>, have a widget name, and attributes e.g.
  <YouTube id="xyz">
*/}
## Hero widget
  <Hero
